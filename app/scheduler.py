...
from app.services.article_extractor import FeedContentFetcher  # Nuova classe
...
def schedule_jobs():
    ...
    scheduler.add_job(feed_association_job,
    ...
    scheduler.add_job(enrich_feed_contents_job,
